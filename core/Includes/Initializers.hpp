/*
    ...
    DESCRIPTION:
    Initialize definitions are located here.

*/

/*  values for crc32 lookup table initialization    */
#define CRC32LOOKUPVALUES {                                         \
...
/*  values for SDL flags lookup table initialization    */
#define SDLFLG {\
